...
def p_var_assing(p):
    '''
    var_assing : ID IGUAL expresion
    '''
    p[0] = ('=', p[1], p[3])                        

def p_instrucciones_evaluar(t):
    '''instruccion : REVALUAR CORIZQ expresion CORDER DPTO
                    | REVALUAR expresion DPTO'''
    print('El valor de la expresión es: ' + str(t[2]))
